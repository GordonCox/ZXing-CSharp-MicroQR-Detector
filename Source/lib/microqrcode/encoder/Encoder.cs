...
using ByteArray = ZXing.Common.ByteArray;
using ByteMatrix = ZXing.MicroQrCode.Internal.ByteMatrix;
using ErrorCorrectionLevel = ZXing.QrCode.Internal.ErrorCorrectionLevel;
using GF256 = ZXing.Common.ReedSolomon.GenericGF;
using Mode = ZXing.MicroQrCode.Internal.Mode;
using ReedSolomonEncoder = ZXing.Common.ReedSolomon.ReedSolomonEncoder;
using Version = ZXing.MicroQrCode.Internal.Version;
...
namespace ZXing.MicroQrCode.Internal
{
    ...
    public sealed class Encoder
    {
        ...
        internal static ByteArray generateECBytes(ByteArray dataBytes, int numEcBytesInBlock)
        {
            ...
            new ReedSolomonEncoder(GF256.QR_CODE_FIELD_256).encode(toEncode, numEcBytesInBlock);
